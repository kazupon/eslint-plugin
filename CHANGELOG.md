# v0.7.1 (2025-12-26T09:44:18Z)

This changelog is generated by [GitHub Releases](https://github.com/kazupon/eslint-plugin/releases/tag/v0.7.1)
...
- fix: wrong ignore glob pattern for type files by @kazupon in https://github.com/kazupon/eslint-plugin/pull/152

**Full Changelog**: https://github.com/kazupon/eslint-plugin/compare/v0.7.0...v0.7.1

# v0.7.0 (2025-12-26T08:16:01Z)

This changelog is generated by [GitHub Releases](https://github.com/kazupon/eslint-plugin/releases/tag/v0.7.0)
...
- feat: support oxlint by @kazupon in https://github.com/kazupon/eslint-plugin/pull/149

### 💥 Breaking Changes

- breaking: change `enforce-header-comment` severity by @kazupon in https://github.com/kazupon/eslint-plugin/pull/151

### ⚡ Improvement Features

- fix: set `meta.defaultOptions` of rules by @kazupon in https://github.com/kazupon/eslint-plugin/pull/147
- fix: tweak default configuration by @kazupon in https://github.com/kazupon/eslint-plugin/pull/148

**Full Changelog**: https://github.com/kazupon/eslint-plugin/compare/v0.6.2...v0.7.0

# v0.6.2 (2025-09-25T02:25:44Z)

This changelog is generated by [GitHub Releases](https://github.com/kazupon/eslint-plugin/releases/tag/v0.6.2)
...
- fix: secure github actions, pnpm, and renovate by @kazupon in https://github.com/kazupon/eslint-plugin/pull/107

**Full Changelog**: https://github.com/kazupon/eslint-plugin/compare/v0.6.1...v0.6.2
